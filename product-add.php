...
<select name="suppliers[]" id="suppliersSelect" multiple> <!-- Allow multiple selections -->
    <option value="" disabled selected>Select Supplier</option> <!-- Fixed and unselectable option -->
    
    <?php
    // Assuming session table management and `show_supplier.php` correctly fetch suppliers.
    $show_table = 'suppliers';
    $suppliers = include('database/show_supplier.php');
